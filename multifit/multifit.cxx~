 ...
 Double_t FuncionqQ23(Double_t x[],  Double_t p[])
{
  ...
  const Double_t So=1/0.15;//valor constante So
...
Double_t FuncionqQ1800bar(Double_t x[],  Double_t p[])
{
  Double_t h=6.58211899E-16;
  Double_t hc2=0.389379338;//Gev^2*mbarn
  Double_t hc=TMath::Sqrt(hc2);
 ...
 Double_t FuncionqQ1376(Double_t x[],  Double_t p[])
{
  ...
  Double_t alfaslope =0.15;//0.15;//constante alfaslope Gev
  const Double_t So=6.6667;//valor constante So
...
void multifit(){
  ...
  TCanvas *micanvas = new TCanvas("canvas","migrafico",2);//300,500,950,470);
  //micanvas->Divide(2,1);
  /*
  ...
  */
  TGraphErrors *gr97 = new TGraphErrors ("datos9GeV.txt");
  gr97->SetMarkerStyle(27);
  gr97->SetMarkerColor(4);
  gr97->SetMarkerSize(0.9);
  gr97->SetLineColorAlpha(4,1);
  gr97->GetXaxis()->SetLimits(-0.3,6.2);
  gr97->SetMinimum(1E-6);
  gr97->SetMaximum(1E+8);

  TGraphErrors *gr13 = new TGraphErrors ("datos13GeV.txt");
  gr13->SetMarkerStyle(26);
  gr13->SetMarkerColor(6);
  gr13->SetMarkerSize(0.9);
  gr13->SetLineColorAlpha(6,1);
  gr13->GetXaxis()->SetLimits(-0.3,6.2);
  gr13->SetMinimum(1E-6);
  gr13->SetMaximum(1E+8);
 
  TGraphErrors *gr0 = new TGraphErrors ("datos19GeV.txt");
  gr0->SetMarkerStyle(28);
  gr0->SetMarkerColor(2);
  gr0->SetMarkerSize(1);
  gr0->SetLineColorAlpha(2,1);
  gr0->GetXaxis()->SetLimits(-0.3,6.2);
  gr0->SetMinimum(1E-6);
  gr0->SetMaximum(1E+8);
  
  TGraphErrors *gr1 = new TGraphErrors ("datos23GeV.txt");
  gr1->SetMarkerStyle(22);
  gr1->SetMarkerColor(4);
  gr1->SetMarkerSize(1);
  gr1->SetLineColorAlpha(4,1);
  gr1->GetXaxis()->SetLimits(-0.3,6.2);
  gr1->SetMinimum(1E-6);
  gr1->SetMaximum(1E+8);

  TGraphErrors *gr2 = new TGraphErrors("datos30GeV.txt");
  gr2->SetMarkerStyle(23);
  gr2->SetMarkerColor(7);
  gr2->SetMarkerSize(1);
  gr2->SetLineColorAlpha(7,1);
  gr2->GetXaxis()->SetLimits(-0.3,6.2);
  gr2->SetMinimum(1E-6);
  gr2->SetMaximum(1E+8);

  TGraphErrors *gr3 = new TGraphErrors("datos44GeV.txt");
  gr3->SetMarkerStyle(24);
  gr3->SetMarkerColor(8);
  gr3->SetMarkerSize(1);
  gr3->SetLineColorAlpha(8,1);
  gr3->GetXaxis()->SetLimits(-0.3,6.2);
  gr3->SetMinimum(1E-6);
  gr3->SetMaximum(1E+8);

   TGraphErrors *gr4 = new TGraphErrors("datos52GeV.txt");
  gr4->SetMarkerStyle(27);
  gr4->SetMarkerColor(6);
  gr4->SetMarkerSize(1);
  gr4->SetLineColorAlpha(6,1);
  gr4->GetXaxis()->SetLimits(-0.3,6.2);
  gr4->SetMinimum(1E-6);
  gr4->SetMaximum(1E+8);

  
  TGraphErrors *gr5 = new TGraphErrors("datos62GeV.txt");
  gr5->SetMarkerStyle(20);
  gr5->SetMarkerColor(9);
  gr5->SetMarkerSize(1);
  gr5->SetLineColorAlpha(9,1);
  gr5->GetXaxis()->SetLimits(-0.3,6.2);
  gr5->SetMinimum(1E-4);
  gr5->SetMaximum(1E+8);
  /*
  TGraphErrors *gr8 = new TGraphErrors("datos630GeVbar.txt");
  gr8->SetMarkerStyle(24);
  gr8->SetMarkerColor(2);
  gr8->SetMarkerSize(1);
  gr8->SetLineColorAlpha(2,1);
  gr8->GetXaxis()->SetLimits(-0.3,3.1);
  gr8->SetMinimum(1E-4);
  gr8->SetMaximum(1E+10);
  
  TGraphErrors *gr7 = new TGraphErrors("datos53GeVbar.txt");
  gr7->SetMarkerStyle(24);
  gr7->SetMarkerColor(2);
  gr7->SetMarkerSize(0.85);
  gr7->SetLineColorAlpha(2,1);
  gr7->GetXaxis()->SetLimits(-0.2,5);
  gr7->SetMinimum(1E-4);
  ...
  TGraphErrors *gr9 = new TGraphErrors("datos19GeVbar.txt");
  gr9->SetMarkerStyle(22);
  gr9->SetMarkerColor(6);
  gr9->SetMarkerSize(1.2);
  gr9->SetLineColorAlpha(6,1);
  gr9->GetXaxis()->SetLimits(-0.2,5);
  gr9->SetMinimum(1E-4);
  gr9->SetMaximum(1E+10);
  
  TGraphErrors *gr10 = new TGraphErrors("datos546GeVbar.txt");
  gr10->SetMarkerStyle(24);
  gr10->SetMarkerColor(9);
  gr10->SetMarkerSize(1);
  gr10->SetLineColorAlpha(9,1);
  gr10->GetXaxis()->SetLimits(-0.3,3.1);
  gr10->SetMinimum(1E-4);
  gr10->SetMaximum(1E+10);
  
  TGraphErrors *gr11 = new TGraphErrors("datos1800GeVbar.txt");
  gr11->SetMarkerStyle(24);
  gr11->SetMarkerColor(8);
  gr11->SetMarkerSize(1);
  gr11->SetLineColorAlpha(8,1);
  gr11->GetXaxis()->SetLimits(-0.3,3.1);
  gr11->SetMinimum(1E-4);
  gr11->SetMaximum(1E+10);
  */
  TGraphErrors *gr70 = new TGraphErrors("datos7TeV.txt");
  gr70->SetMarkerStyle(24);
  gr70->SetMarkerColor(2);
  gr70->SetMarkerSize(1);
  gr70->SetLineColorAlpha(2,1);
  gr70->GetXaxis()->SetLimits(-0.3,6.2);
  ...
  mg1->Add(gr70);
  mg1->Draw("AP");
  mg1->GetXaxis()->SetLimits(-0.3,6.2);
  mg1->SetMinimum(1E-12);
  mg1->SetMaximum(1E+26);
  ...
  f0->SetParLimits(1,1,9);
  f0->SetNpx(2000);
  gr0->Fit(f0);
  
  TF1 *f1 = new TF1("funajuste",FuncionqQ23,0,7,4);
  f1->SetLineWidth(1);
  f1->SetLineColor(1);
  //f2->SetParameters(8,5.5,0.024,1.5);
  f1->SetParameters(6,6,0.014,5);
  f1->SetParLimits(1,1,9);
  f1->SetNpx(2000);
  gr1->Fit(f1);
  
  TF1 *f2 = new TF1("funajuste",FuncionqQ30,0,7,4);
  f2->SetLineWidth(1);
  f2->SetLineColor(1);
  f2->SetParameters(6,5,0.014,5);
  f2->SetParLimits(1,1,9);
  f2->SetNpx(2000);
  gr2->Fit(f2);
  ...
  f5->SetLineWidth(1);
  f5->SetLineColor(1);
  f5->SetParameters(6,7,0.04,1);
  f5->SetParLimits(1,1,9);
  f5->SetNpx(2000);
  gr5->Fit(f5);
  /*
  ...
  gr46->Fit(f462);
  */
  TF1 *f13 = new TF1("funajuste",FuncionqQ1376,0,5,3);
  f13->SetLineWidth(1);
  f13->SetLineColor(1);
  f13->SetParameters(7,5,0.024);
  f13->SetNpx(2000);
  gr13->Fit(f13);

  TF1 *f97 = new TF1("funajuste",FuncionqQ978,0,5,3);
  f97->SetLineWidth(1);
  f97->SetLineColor(1);
  f97->SetParameters(7,5,0.014);
  f97->SetNpx(2000);
  gr97->Fit(f97);

  TF1 *f70 = new TF1("funajuste",FuncionqQ7000,0,5,3);
  f70->SetLineWidth(1);
  f70->SetLineColor(1);
  f70->SetNpx(2000);
  f70->SetParameters(8,5.5,0.024);
  gr70->Fit(f70);
  ...
  TF1 *f7 = new TF1("funajuste",FuncionqQ53bar,0,5,3);
  f7->SetLineWidth(1);
  f7->SetLineColor(1);
  f7->SetParameters(6,2,0.024);
  gr7->Fit(f7);
  
  TF1 *f8 = new TF1("funajuste",FuncionqQ630bar,0,5,3);
  f8->SetLineWidth(1);
  f8->SetLineColor(1);
  f8->SetParameters(6,2,0.024);
  gr8->Fit(f8);
  
  TF1 *f9 = new TF1("funajuste",FuncionqQ194bar,0,5,3);
  f9->SetLineWidth(1);
  f9->SetLineColor(1);
  f9->SetParameters(5,1.5,0.024);
  gr9->Fit(f9);
  
  TF1 *f10 = new TF1("funajuste",FuncionqQ546bar,0,5,3);
  f10->SetLineWidth(1);
  f10->SetLineColor(1);
  f10->SetParameters(5.5,5,0.024);
  gr10->Fit(f10);
  
  TF1 *f11 = new TF1("funajuste",FuncionqQ1800bar,0,5,3);
  f11->SetLineWidth(1);
  f11->SetLineColor(1);
  f11->SetParameters(6,5,0.024);
  gr11->Fit(f11);
  ...
  legend->AddEntry(gr11,"1.8-1.96 TeV","lep");
  legend->AddEntry(gr6,"1.960 TeV","lep");
  legend->AddEntry(f9,"Modelo qQ");
